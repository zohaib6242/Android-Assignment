...
interface GeneralApi {
    ...
    @GET(value = WebServiceConstant.GET_CO_PILOT_LIST)
    suspend fun getCoPilotList(@Header("Authorization") authToken: String): NetworkResponse<CoPilotApiResponse, ErrorResponse>
}
